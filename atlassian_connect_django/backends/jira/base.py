...
from atlassian_connect_django.backends.common.base import AtlassianDatabaseWrapper, AtlassianDatabaseCursor, AtlassianDatabaseOperations, AtlassianDatabaseConvertion



logger = logging.getLogger('atlassian_connect_django.backends.jira')
...
class DatabaseIntrospection(BaseDatabaseIntrospection):
    data_types_reverse = {
        ...
        'number': 'FloatField',
        'string': 'TextField',
        'array': 'atlassian_connect_django.models.fields.ArrayField',
        'issuetype': 'TextField',
        'user': 'TextField',
        'project': 'TextField',
    ...
    data_type_relations = [
       ...
       'com.atlassian-connect-django:parent'
    ]
...
class DatabaseCursor(AtlassianDatabaseCursor):
    ...
    def request_fields(self, fields=None):
        ...
        c = {
            ...
            "schema": {
                "type": "any",
                "custom": "com.atlassian-connect-django:parent"
            }
        }
        content.append(c)
        return content
...
class DatabaseConvertion(AtlassianDatabaseConvertion):
    ...
    def from_native(self, data, field):
        if field[1] == 'project' and data is not None:
            return data['key']
        # Handle the parent
        elif field[1] == 'com.atlassian-connect-django:parent':
            if data:
                return data['key']
            else:
                return None
...
class DatabaseOperations(AtlassianDatabaseOperations):
    compiler_module = "atlassian_connect_django.backends.jira.compiler"
