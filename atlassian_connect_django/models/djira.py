...
from atlassian_connect_django.backends.jira.base import DatabaseConvertion
...
class IssueLinks(object):
    ...
    def __init__(self, model):
        ...
        db_settings = connections.databases[db_alias]
        if db_settings['ENGINE'] != 'atlassian_connect_django.backends.jira':
            return
...
def create_model(name):
    ...
    class Meta:
        pass
    setattr(Meta, 'app_label', 'atlassian_connect_django')
...
def add_fields(sender, **kwargs):
    ...
    if db['ENGINE'] != 'atlassian_connect_django.backends.jira':
        return
